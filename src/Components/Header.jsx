...
const Header = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl font-semibold tracking-widest text-violet-300">Sanket</h1>
      ...
      <div className="flex gap-6 items-center">
        <div className="hidden md:flex gap-6">
          {[
            { icon: FaLinkedin, name: "LinkedIn", link: "https://www.linkedin.com/in/sanket-321za" },
            { icon: FaGithub, name: "GitHub", link: "https://github.com/Sanket33221" },
            { 
              ...
              name: "LeetCode", 
              link: "https://leetcode.com/u/sanketprasad2004/" 
            },
