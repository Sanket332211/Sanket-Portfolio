          ...
          <div className="backdrop-blur-md bg-black bg-opacity-30 rounded-xl p-6 sm:p-8 border border-gray-700 shadow-lg">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3">
                    {[
                      { label: "primary", email: "sanketprasad2004@gmail.com" },
                    ].map(({ label, email }) => (
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://wa.me/917870236724" target="_blank" rel="noopener noreferrer" className="bg-green-600 bg-opacity-20 p-3 rounded-lg hover:bg-opacity-30 transition-all">
              ...
              {[
                {
                  ...
                  email: "sanketprasad2004@gmail.com",
